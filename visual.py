...
from analysis import calc_ppk, control_beyond_limits, \
...
def ppk_plot(data: (pd.Series, np.array),
...
def cpk_plot(data: (pd.Series, np.array),
             upper_control_limit: (int, float), lower_control_limit: (int, float),
             subgroup_size: int = 30, max_subgroups: int = 10, axs:int = None):
    """
...
def control_plot(data: (pd.Series, np.array),
                 upper_control_limit: (int, float), lower_control_limit: (int, float),
